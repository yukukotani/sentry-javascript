/**
 * TO USE THIS TO PREVENT MANGLING DURING TRACING, SO YOU CAN SEE WHAT GETS TREESHAKEN:
 *
 * 1. Change the name of this file to just `index.js`
 * 2. Move it inside of `<root of your nextjs project>/node_modules/next/dist/build/webpack/plugins/terser-webpack-plugin/src/`
 */
...
class TerserPlugin {
  constructor(options = {}) {
    const { cacheDir: cacheDir1, terserOptions: tOptions = {}, parallel, swcMinify } = options;
    this.options = {
      swcMinify,
      cacheDir: cacheDir1,
      parallel,
      terserOptions: {
        ...
        compress: {
          ...
          comparisons: false,
          inline: 2,
          // end stuff from next.js

          // how many times to scan through looking for compression opportunities
          passes: 2,
